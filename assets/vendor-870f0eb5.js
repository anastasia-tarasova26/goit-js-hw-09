...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
  ...
  function E(r, n) {
    if (r) {
      if (typeof r == "string") return b(r, n);
  ...
  var Y = (function () {
        ...
        k(r, [
                  ...
                  typeof e.options.captionSelector == "string"
                    ...
                    e.options.captions &&
                      ...
                      (e.options.captionType === "data"
                        ? (p = h.dataset[e.options.captionsData])
                        : e.options.captionType === "text"
                        ? (p = h.innerHTML)
                        : (p = h.getAttribute(e.options.captionsData))),
                    e.options.loop
                    ...
                    t === 1 || t === -1
                      ? (e.options.animationSlide &&
                        ...
                        e.fadeIn(
                          ...
                          e.options.fadeSpeed,
                          function () {
                            (e.isAnimating = !1), e.setCaption(p, s);
                          }
                        ))
                      : ((e.isAnimating = !1), e.setCaption(p, s)),
          ...
          },
          {
            ...
            value: function (t) {
              ...
              return { height: o - d - a - s - l, width: i - c - h - p - u };
            },
          },
          {
            key: "updateHash",
    ...
    M = Y;
  (g.default = M), (W.SimpleLightbox = Y);
})(X);
const F = R(X);
export { F as S };
